...
# -*- coding:utf-8 -*-
"""
YOLOX-Tiny experiment for PEGMA datasets.
Based on the original custom_tiny_exp.py implementation.

Model size: YOLOX-Tiny (depth=0.33, width=0.375, ~5.06M params)
...
Usage:
    ...
    python tools/train.py -f exps/pegma/yolox_nano_pegma.py -d 0 -b 16
...
class Exp(BaseExp):
    """
    YOLOX experiment for PEGMA datasets.
    ...
    def __init__(self):
        ...
        # ==================== MODEL CONFIGURATION ====================
        # YOLOX-Tiny model settings (matching old custom_tiny_exp.py)
        self.depth = 0.33
        self.width = 0.375  # Tiny size (Nano would be 0.25)
        ...
        self.exp_name = "yolox_tiny_detection"
        
        # Output directory - use runs/ to match YOLOv8 structure
        # Final path will be: output_dir/exp_name/ (e.g., runs/yolox_detection/)
...
if __name__ == '__main__':
    ...
    print(f"Model: YOLOX-Tiny (depth={exp.depth}, width={exp.width})")
