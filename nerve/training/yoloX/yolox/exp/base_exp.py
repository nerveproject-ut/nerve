        ...
        for k, v in zip(cfg_list[0::2], cfg_list[1::2]):
            ...
            if hasattr(self, k):
                ...
                if src_value is not None and src_type != type(v):
                    # Special handling for boolean types: bool("False") returns True
                    # because any non-empty string is truthy. We need to parse the
                    # string value properly.
                    if src_type == bool and isinstance(v, str):
