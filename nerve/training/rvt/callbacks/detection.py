...
from nerve.training.rvt.utils.evaluation.prophesee.visualize.vis_utils import LABELMAP_GEN1, LABELMAP_GEN4_SHORT, LABELMAP_PEGMA, draw_bboxes
...
class DetectionVizCallback(VizCallbackBase):
    def __init__(self, config: DictConfig):
        ...
        elif dataset_name == 'pegma':
            self.label_map = LABELMAP_PEGMA
        else:
    ...
    def on_validation_epoch_end_custom(self, logger: SupportedLogger):
