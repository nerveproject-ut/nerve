...
CLI_HELP_MSG = \
    ...
    """
CFG_FLOAT_KEYS = {'warmup_epochs', 'box', 'cls', 'dfl', 'max_zoom_out_factor', 'min_zoom_out_factor', 'min_dist', 'max_dist', 'dist_loss_mult'}
...
CFG_INT_KEYS = {'batchs_init', 'val_epoch', 'channels', 'clip_length', 'clip_stride',
    ...
    'line_thickness', 'workspace', 'nbs', 'save_period', 'val_epoch', 'channels', 'nbins'}
CFG_BOOL_KEYS = {
    ...
    'optimize', 'dynamic', 'rect', 'speed', 'zero_hidden', 'distance'}
