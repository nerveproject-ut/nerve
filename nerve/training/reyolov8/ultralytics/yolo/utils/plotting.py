...
def plot_images(images,
    ...
    for i in range(i + 1):
        ...
        # Handle cls that may be scalar (0-d array) or empty
        # Use try/except because numpy 0-d arrays have __len__ but len() fails
        try:
            cls_has_elements = cls is not None and len(cls) > 0
        except TypeError:
            cls_has_elements = False
        if cls_has_elements:
            idx = batch_idx == i
